...
residing_directory = os.path.dirname(os.path.realpath(__file__))
...
if __name__ == '__main__':
    ...
    a = time()
    is_car_image_results: List[bool] = Parallel(n_jobs=-2)(
    ...
    open(os.path.join(residing_directory, 'car_in_top_5_file_names.txt'), 'w').write('\n'.join(car_image_file_names))
